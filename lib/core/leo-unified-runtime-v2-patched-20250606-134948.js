...
// Final Clean Patched Version: ensures claudeFunctionBindings is confirmed and awaited
...
class CognitiveLeo {
  constructor(sessionId) {
    ...
    this.identityDir = path.join(this.dataDir, 'identity');
  ...
  initializeClaude() {
    try {
      ...
      if (global.claudeFunctionBindings) {
        console.log('🔗 Claude function bindings registered');
      } else {
        console.warn('⚠️ Claude function bindings NOT registered.');
      }
