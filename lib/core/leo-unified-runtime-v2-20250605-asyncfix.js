// Leo Unified Runtime v2 with Async Claude Integration Fix
// Generated: 2025-06-05-asyncfix
...
class CognitiveLeo {
  ...
  async initializeClaude() {
    try {
      this.sdk = await initializeClaudeInterface(this);
...
(async () => {
  const leo = new CognitiveLeo("cognitive-leo-v2-20250605-asyncfix");
  global.leo = leo;
